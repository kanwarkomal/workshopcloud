...
btn.onclick = function() {
  ...
  text.innerHTML=`Hey  <strong>${inputText.value}</strong>, buckle up!  You're officially locked in for Team Vibhav's epic Cloud Computing Workshop.

  Get ready to blast off into the future of tech  where you'll:
  
  Crack the code of cloud concepts by demystifying the cloud like a superhero..`
